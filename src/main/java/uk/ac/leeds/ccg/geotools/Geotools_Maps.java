...
//    }
    ...
    public Path getOutputImageFile(Path outputFile, String outputType) {
        ...
        outputImageFilename = filename.substring(0, filename.length() - 4)
                + "." + outputType;
        r = Paths.get(outputFile.getParent().toString(), outputImageFilename);
        return r;
    }
...
//    }
     ...
     * counts.
     */
    protected Object[] getLevelData(Path dir, String[] filenames,
...
//                    return null;
     ...
     */
    protected Object[] getLevelData(Path dir, String filename) {
...
//    }
    ...
    public Path createShapefileIfItDoesNotExist(Path dir, String name,
            ...
            throws IOException {
        sdsf = new ShapefileDataStoreFactory();
        return createShapefileIfItDoesNotExist(dir, name, fc, sft, sdsf);
    }
    ...
    public Path createShapefileIfItDoesNotExist(Path dir, String name,
        ...
        Path r = env.getShapefile(dir, name, true);
        if (!Files.exists(r)) {
    ...
    public Path createLineGridShapefileIfItDoesNotExist(Path dir, String name,
        ...
        SimpleFeatureType sft = getLineSimpleFeatureType(getDefaultSRID());
        TreeSetFeatureCollection fc = getLineGridFeatureCollection(sft, nrows,
